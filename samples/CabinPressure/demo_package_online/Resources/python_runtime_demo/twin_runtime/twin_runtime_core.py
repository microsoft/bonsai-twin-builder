...
class TwinRuntime:
    ...
    def evaluate_twin_status(self, twin_status, twin_runtime, method_name):
        if twin_status == 1:
            ...
            message += "TwinRuntime error message :" + twin_runtime.twin_get_status_string()
            raise TwinRuntimeError('{}'.format(message), twin_runtime)
    ...
    def evaluate_twin_prop_status(self, prop_status, twin_runtime, method_name, var):
        if prop_status == 4:
